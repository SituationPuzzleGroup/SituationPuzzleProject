...
本專案為**巨匠電腦 Java 程式設計課程期末專題**，採限制性授權（非開源條款）：

- ✅ 允許：課程 Demo 展示、非營利之學術與教學用途、專題成員修改
- ❌ 禁止：商業使用、非專題成員修改或散布、再授權

音樂與背景素材屬第三方位作品，依各原作者授權條款使用，不在本專案授權範圍內。完整條款詳見 [LICENSE](LICENSE)。
